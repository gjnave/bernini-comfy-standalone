...
Builds the official task-aware prompt-enhancement instructions. The ComfyUI
node emits these instructions for external API nodes instead of calling an API
internally.
"""
...
def parse_prompt_response(response_text: str, original_prompt: str = "", json_mode: bool = False) -> str:
    """Parse an external API node response into the final Bernini prompt."""
